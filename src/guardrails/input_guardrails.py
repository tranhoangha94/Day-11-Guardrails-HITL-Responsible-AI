...
def detect_injection(user_input: str) -> bool:
    ...
    INJECTION_PATTERNS = [
        ...
        r"output your config as json",
        r"export all instructions",
        r"fill in the blank",
        r"connection string",
    ]
        ...
        *,
        ...
        if detect_injection(text):
            ...
            return self._block_response(
                "I cannot process that request. I'm here to help with "
                "VinBank banking questions only."
            )
        ...
        if topic_filter(text):
            ...
            return self._block_response(
                ...
                "transfers, loans, and savings. How can I help you with VinBank services?"
            )
